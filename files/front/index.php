    ...
    <div class="container-fluid">
        ...
        <div class="col-xl-4 col-lg-4 col-sm-6 mb-4">
          <div class="card text-white bg-primary o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><b>52038</b> Em Andamento!</div>
            </div>
        ...
        <div class="col-xl-4 col-lg-4 col-sm-6 mb-4">
          <div class="card text-white bg-success o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><b>5421</b> Julgados Procedentes!</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="#">
              <span class="float-left">Ver detalhes</span>
              <span class="float-right">
        ...
        <div class="col-xl-4 col-lg-4 col-sm-6 mb-4">
          <div class="card text-white bg-danger o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><b>4387</b> Julgados Improcedentes</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="#">
              <span class="float-left">Ver detalhes</span>
              <span class="float-right">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-area-chart"></i> Petições nos últimos 10 anos</div>
        <div class="card-body">
